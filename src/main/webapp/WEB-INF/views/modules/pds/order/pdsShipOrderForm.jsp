...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/pds/order/pdsShipOrder/">送货单列表</a></li>
		<li class="active"><a href="${ctx}/pds/order/pdsShipOrder/form?id=${pdsShipOrder.id}">送货单<shiro:hasPermission name="pds:order:pdsShipOrder:edit">${not empty pdsShipOrder.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="pds:order:pdsShipOrder:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="pdsShipOrder" action="${ctx}/pds/order/pdsShipOrder/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="arriveTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${pdsShipOrder.arriveTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="acceptTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${pdsShipOrder.acceptTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="pds:order:pdsShipOrder:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
