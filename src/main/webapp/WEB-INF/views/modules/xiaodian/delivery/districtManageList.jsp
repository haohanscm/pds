...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/xiaodian/delivery/districtManage/">片区管理列表</a></li>
		<shiro:hasPermission name="xiaodian:delivery:districtManage:edit"><li><a href="${ctx}/xiaodian/delivery/districtManage/form">片区管理添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="districtManage" action="${ctx}/xiaodian/delivery/districtManage/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>更新时间</th>
				<th>备注信息</th>
				<shiro:hasPermission name="xiaodian:delivery:districtManage:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="districtManage">
			<tr>
				<td><a href="${ctx}/xiaodian/delivery/districtManage/form?id=${districtManage.id}">
					${districtManage.id}
				</a></td>
				<td>
					${districtManage.name}
				...
				<td>
						${districtManage.provinceName}
				</td>
				<td>
						${districtManage.cityName}
				</td>
				<td>
						${districtManage.regionName}
				</td>
				<%--<td>--%>
				...
				<shiro:hasPermission name="xiaodian:delivery:districtManage:edit"><td>
    				<a href="${ctx}/xiaodian/delivery/districtManage/form?id=${districtManage.id}">修改</a>
					<a href="${ctx}/xiaodian/delivery/districtManage/delete?id=${districtManage.id}" onclick="return confirmx('确认要删除该片区管理吗？', this.href)">删除</a>
