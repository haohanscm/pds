...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/xiaodian/delivery/deliverManManage/">配送员列表</a></li>
		<shiro:hasPermission name="xiaodian:delivery:deliverManManage:edit"><li><a href="${ctx}/xiaodian/delivery/deliverManManage/form">配送员添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="deliverManManage" action="${ctx}/xiaodian/delivery/deliverManManage/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>更新时间</th>
				<th>备注信息</th>
				<shiro:hasPermission name="xiaodian:delivery:deliverManManage:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="deliverManManage">
			<tr>
				...
				<td><a href="${ctx}/xiaodian/delivery/deliverManManage/form?id=${deliverManManage.id}">
				...
				<shiro:hasPermission name="xiaodian:delivery:deliverManManage:edit"><td>
    				<a href="${ctx}/xiaodian/delivery/deliverManManage/form?id=${deliverManManage.id}">修改</a>
					<a href="${ctx}/xiaodian/delivery/deliverManManage/delete?id=${deliverManManage.id}" onclick="return confirmx('确认要删除该配送员吗？', this.href)">删除</a>
