...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/xiaodian/delivery/districtManage/">片区管理列表</a></li>
		<li class="active"><a href="${ctx}/xiaodian/delivery/districtManage/form?id=${districtManage.id}">片区管理<shiro:hasPermission name="xiaodian:delivery:districtManage:edit">${not empty districtManage.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="xiaodian:delivery:districtManage:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="districtManage" action="${ctx}/xiaodian/delivery/districtManage/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="xiaodian:delivery:districtManage:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
