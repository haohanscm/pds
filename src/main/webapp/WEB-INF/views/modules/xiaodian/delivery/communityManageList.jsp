...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/xiaodian/delivery/communityManage/">小区信息列表</a></li>
		<shiro:hasPermission name="xiaodian:delivery:communityManage:edit"><li><a href="${ctx}/xiaodian/delivery/communityManage/form">小区信息添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="communityManage" action="${ctx}/xiaodian/delivery/communityManage/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="communityManage">
			<tr>
				...
				<td><a href="${ctx}/xiaodian/delivery/communityManage/form?id=${communityManage.id}">
				...
				<shiro:hasPermission name="xiaodian:delivery:communityManage:edit"><td>
    				<a href="${ctx}/xiaodian/delivery/communityManage/form?id=${communityManage.id}">修改</a>
					<a href="${ctx}/xiaodian/delivery/communityManage/delete?id=${communityManage.id}" onclick="return confirmx('确认要删除该小区信息吗？', this.href)">删除</a>
