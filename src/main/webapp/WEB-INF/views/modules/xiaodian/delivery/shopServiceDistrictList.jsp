...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/xiaodian/delivery/shopServiceDistrict/">店铺服务小区列表</a></li>
		<shiro:hasPermission name="xiaodian:delivery:shopServiceDistrict:edit"><li><a href="${ctx}/xiaodian/delivery/shopServiceDistrict/form">店铺服务小区添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="shopServiceDistrict" action="${ctx}/xiaodian/delivery/shopServiceDistrict/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>服务片区id：</label>
				<form:input path="districtAreaId" htmlEscape="false" maxlength="64" class="input-medium"/>
			</li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>更新时间</th>
				<th>备注信息</th>
				<shiro:hasPermission name="xiaodian:delivery:shopServiceDistrict:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="shopServiceDistrict">
			<tr>
				<td><a href="${ctx}/xiaodian/delivery/shopServiceDistrict/form?id=${shopServiceDistrict.id}">
				...
				<shiro:hasPermission name="xiaodian:delivery:shopServiceDistrict:edit"><td>
    				<a href="${ctx}/xiaodian/delivery/shopServiceDistrict/form?id=${shopServiceDistrict.id}">修改</a>
					<a href="${ctx}/xiaodian/delivery/shopServiceDistrict/delete?id=${shopServiceDistrict.id}" onclick="return confirmx('确认要删除该店铺服务小区吗？', this.href)">删除</a>
