...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/xiaodian/delivery/deliveryPlan/">配送计划列表</a></li>
		<li class="active"><a href="${ctx}/xiaodian/delivery/deliveryPlan/form?id=${deliveryPlan.id}">配送计划<shiro:hasPermission name="xiaodian:delivery:deliveryPlan:edit">${not empty deliveryPlan.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="xiaodian:delivery:deliveryPlan:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="deliveryPlan" action="${ctx}/xiaodian/delivery/deliveryPlan/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
