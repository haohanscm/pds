...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/xiaodian/delivery/communityManage/">小区信息列表</a></li>
		<li class="active"><a href="${ctx}/xiaodian/delivery/communityManage/form?id=${communityManage.id}">小区信息<shiro:hasPermission name="xiaodian:delivery:communityManage:edit">${not empty communityManage.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="xiaodian:delivery:communityManage:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="communityManage" action="${ctx}/xiaodian/delivery/communityManage/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
