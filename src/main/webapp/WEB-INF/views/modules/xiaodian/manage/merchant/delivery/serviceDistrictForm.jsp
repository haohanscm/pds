...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/xiaodian/manage/merchant/delivery/serviceDistrict/list">店铺服务小区列表</a></li>
		<li class="active"><a href="${ctx}/xiaodian/manage/merchant/delivery/serviceDistrict/form?id=${shopServiceDistrict.id}">店铺服务小区<shiro:hasPermission name="xiaodian:manage:merchant:delivery:edit">${not empty shopServiceDistrict.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="xiaodian:manage:merchant:delivery:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="shopServiceDistrict" action="${ctx}/xiaodian/manage/merchant/delivery/serviceDistrict/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
