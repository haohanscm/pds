...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/xiaodian/manage/merchant/delivery/man/list">配送员列表</a></li>
		<li class="active"><a href="${ctx}/xiaodian/manage/merchant/delivery/man/form?id=${deliverManManage.id}">配送员<shiro:hasPermission name="xiaodian:manage:merchant:delivery:edit">${not empty deliverManManage.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="xiaodian:manage:merchant:delivery:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="deliverManManage" action="${ctx}/xiaodian/manage/merchant/delivery/man/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">配送员是否绑定微信：</label>
			<div class="controls">
