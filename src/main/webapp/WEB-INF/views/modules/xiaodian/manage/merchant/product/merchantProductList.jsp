...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/xiaodian/manage/merchant/product/list">商品列表</a></li>
		<li><a href="${ctx}/xiaodian/manage/merchant/product/form">商品添加</a></li>
	</ul>
	...
	<form:form id="searchForm" modelAttribute="goods" action="${ctx}/xiaodian/manage/merchant/product/list" method="post" class="breadcrumb form-search">
        ...
        <c:if test="${not empty jisuAppList}">
            <ul class="ul-form">
                <li class="btns">
                    同步的店铺：
                        <%--<input id="syncShopId" class="input-xlarge" type="text" />--%>
                    ...
                    <input id="syncGoodsData" class="btn btn-primary" type="button" value="同步店铺商品"/>
                </li>
            </ul>
        </c:if>
	...
	<table id="contentTable" class="table table-hover">
		<thead>
			<tr>
				...
				<th>是否上架</th>
				<th>更新时间</th>
				<shiro:hasPermission name="xiaodian:manage:merchant:product:edit"><th style="width: 150px">操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="goods" varStatus="goodsStatus">
			<tr>
                ...
                <td><a href="${ctx}/xiaodian/manage/merchant/product/list?shopId=${goods.shopId}">
				...
				<shiro:hasPermission name="xiaodian:manage:merchant:product:edit"><td>
    				<a href="${ctx}/xiaodian/manage/merchant/product/form?id=${goods.id}">修改</a>
					<a href="${ctx}/xiaodian/manage/merchant/product/delete?id=${goods.id}" onclick="return confirmx('确认要删除该商品吗？', this.href)">删除</a>
                    <a href="${ctx}/xiaodian/manage/merchant/product/copy?id=${goods.id}">复制</a>
