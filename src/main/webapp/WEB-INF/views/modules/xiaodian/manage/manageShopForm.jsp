...
<head>
    ...
    <%--&lt;%&ndash;<link href="${ctxStatic}/jquery-select2/3.4/select2.min.css" rel="stylesheet" />&ndash;%&gt;--%>
    <%--&lt;%&ndash;<script src="${ctxStatic}/jquery-select2/3.4/select2.min.js" type="text/javascript"></script>&ndash;%&gt;--%>
    ...
    <%--&lt;%&ndash;<script src="${ctxStatic}/common/haohan.js" type="text/javascript"></script>&ndash;%&gt;--%>
