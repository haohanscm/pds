...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/xiaodian/manage/merchant/delivery/serviceArea/list">配送服务区域列表</a></li>
		<shiro:hasPermission name="xiaodian:manage:merchant:delivery:edit"><li><a href="${ctx}/xiaodian/manage/merchant/delivery/serviceArea/form">配送服务区域添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="deliverServiceArea" action="${ctx}/xiaodian/manage/merchant/delivery/serviceArea/list" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="deliverServiceArea">
			<tr>
				<td><a href="${ctx}/xiaodian/manage/merchant/delivery/serviceArea/form?id=${deliverServiceArea.id}">
				...
				<shiro:hasPermission name="xiaodian:manage:merchant:delivery:edit"><td>
    				<a href="${ctx}/xiaodian/manage/merchant/delivery/serviceArea/form?id=${deliverServiceArea.id}">修改</a>
					<a href="${ctx}/xiaodian/manage/merchant/delivery/serviceArea/delete?id=${deliverServiceArea.id}" onclick="return confirmx('确认要删除该配送服务区域吗？', this.href)">删除</a>
