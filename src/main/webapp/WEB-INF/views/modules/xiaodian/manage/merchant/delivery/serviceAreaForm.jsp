...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/xiaodian/manage/merchant/delivery/serviceArea/list">配送服务区域列表</a></li>
		<li class="active"><a href="${ctx}/xiaodian/manage/merchant/delivery/serviceArea/form?id=${deliverServiceArea.id}">配送服务区域<shiro:hasPermission name="xiaodian:manage:merchant:delivery:edit">${not empty deliverServiceArea.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="xiaodian:manage:merchant:delivery:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="deliverServiceArea" action="${ctx}/xiaodian/manage/merchant/delivery/serviceArea/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
