...
<head>
	...
	<script type="text/javascript">
        ...
        <%--function genOrder() {--%>
            <%--window.location.href="${ctx}/xiaodian/manage/merchant/order/genOrderForm";--%>
        <%--}--%>
	</script>
    <style type="text/css">
        .well{
...
<body>
    <form:form id="searchForm" modelAttribute="merchantTurnover" action="${ctx}/xiaodian/manage/merchant/orderQuery" method="post" class="breadcrumb form-search">
        ...
        <ul class="ul-form">
            ...
            <li><label>支付状态：</label>
                <form:select path="payStatus" class="input-medium">
                    <form:option value="" label="已付款或退款中"/>
            ...
            <%--<li class="btns"><input id="btnGenOrder" class="btn btn-primary" type="button" value="代客下单" onclick="genOrder()"/></li>--%>
