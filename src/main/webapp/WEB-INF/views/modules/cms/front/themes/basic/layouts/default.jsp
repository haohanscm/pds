...
<html>
<head>
	<title><sitemesh:title default="欢迎光临"/> - ${site.title} - Powered By Haohanwork.com</title>
            ...
            <ul id="main_nav" class="nav nav-pills">
			    ...
			    <li id="siteSwitch" class="dropdown">
					...
					<ul class="dropdown-menu">
						<%--<c:forEach items="${fnc:getSiteList()}" var="site"><li><a href="#" onclick="location='${ctx}/index-${site.id}${fns:getUrlSuffix()}' ">${site.title}</a></li></c:forEach>--%>
					</ul>
				</li>
