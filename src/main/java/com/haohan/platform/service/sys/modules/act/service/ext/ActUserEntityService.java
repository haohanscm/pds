...
//		}
        ...
        if (user != null) {
            getSystemService().deleteUser(new com.haohan.platform.service.sys.modules.sys.entity.User(user.getId()));
        }
    }
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
        ...
        for (Role role : getSystemService().findRole(new Role(new com.haohan.platform.service.sys.modules.sys.entity.User(null, userId)))) {
