...
import com.haohan.platform.service.sys.modules.sys.dao.*;
import com.haohan.platform.service.sys.modules.sys.entity.*;
...
//			subject.logout();
	...
	public static User fetchByName(String name) {
        User user = new User();
        user.setName(name);
        List<User> list = userDao.fetchByName(user);
        // 有重复的情况下返回空
