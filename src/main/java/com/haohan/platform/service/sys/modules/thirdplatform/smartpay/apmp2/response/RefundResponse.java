...
public class RefundResponse extends BaseResponse {
	...
	private String walletRefundTransId;
	private String walletRefundOrderId;
	...
	public String getWalletRefundTransId() {
		return walletRefundTransId;
	}

	public void setWalletRefundTransId(String walletRefundTransId) {
		this.walletRefundTransId = walletRefundTransId;
	}

	public String getWalletRefundOrderId() {
		return walletRefundOrderId;
	}

	public void setWalletRefundOrderId(String walletRefundOrderId) {
		this.walletRefundOrderId = walletRefundOrderId;
	}
}
