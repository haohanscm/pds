...
import com.haohan.platform.service.sys.modules.xiaodian.entity.retail.JisuModelInfo;
...
public class ReqGoods implements Serializable {
    ...
    private List<GoodsModelTotal> modelTotalList; // 规格名称列表
    ...
    public List<GoodsModelTotal> getModelTotalList() {
        return modelTotalList;
    }

    public void setModelTotalList(List<GoodsModelTotal> modelTotalList) {
    ...
    public GoodsInfoExt transfBaseGoods(GoodsInfoExt goods) {
        ...
        goods.setVirtualPrice(this.virtualPrice);
        goods.setVipPrice(this.vipPrice);
        goods.setUnit(this.unit);
        // 规格
        goods.setGoodsModelList(this.goodsModelList);
        goods.setModelInfo(this.modelInfo);
        goods.setInfoList(this.modelTotalList);
        return goods;
    }
