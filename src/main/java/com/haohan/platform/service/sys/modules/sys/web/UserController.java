...
import com.haohan.platform.service.sys.common.beanvalidator.BeanValidators;
...
import com.haohan.platform.service.sys.modules.ldap.LdapService;
...
public class UserController extends BaseController {
	...
	public String save(User user, HttpServletRequest request, Model model, RedirectAttributes redirectAttributes) {
		...
		//创建Ldap账户   默认创建
//        if(!StringUtils.equals(user.getCreateLdap(), ICommonConstant.YesNoType.no.getCode())){
	...
	public String modifyPwd(String oldPassword, String newPassword, Model model) {
		...
		if (StringUtils.isNotBlank(oldPassword) && StringUtils.isNotBlank(newPassword)){
			...
			if (SystemService.validatePassword(oldPassword, user.getPassword())){
				...
				ldapService.modifyPassword(user.getLoginName(),newPassword);
